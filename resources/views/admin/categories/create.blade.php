                ...
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            ...
                            <form action="{{ route('admin.categories.store') }}" method="POST" name="create_categorie" id="create_categorie" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group row gutters">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="nom_categorie" id="nom_categorie" class="form-control" value="{{ old('nom_categorie') }}" placeholder="Entrez le nom de la catégorie" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row gutters">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea name="description" id="description" class="form-control" rows="3" placeholder="Description optionnelle">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
